...
<body style="font-family: Arial, sans-serif; font-size: 14px; color: #333; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto;">
        <div class="header" style="background-color: #1a365d; color: white; padding: 6px 16px 8px 16px;">
            <table cellpadding="0" cellspacing="0" border="0" style="margin: 0; padding: 0; border-collapse: collapse; width: 100%;">
                <tr>
                    <td style="vertical-align: middle; padding: 0 8px 0 0; margin: 0; text-align: left;">
                        <img src="https://www.proplasticsinc.com/images/ppi-logo.png" alt="Pro Plastics Inc." width="64" height="64" style="display: block; margin: 0; padding: 0; border: 0; float: left;">
                    </td>
                    <td style="vertical-align: middle; padding: 0; margin: 0; text-align: left;">
                    ...
                    <td style="vertical-align: top; text-align: right; padding: 0; margin: 0;">{f'<div style="font-size: 11px; color: #a0aec0;">Submitted: {html_lib.escape(submitted_at)}</div>' if submitted_at else ''}</td>
                </tr>
            </table>
            <div style="font-size: 14px; color: #e2e8f0; border-top: 1px solid #2d4a6f; padding-top: 6px; margin: 0; text-align: left;">{html_lib.escape(email_header_title)}</div>
        </div>
